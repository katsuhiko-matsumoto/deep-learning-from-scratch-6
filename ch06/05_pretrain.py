...
model_save_path = add_ggl_drive_path+'model_pretrain.pt'
...
eval_iters = 500
grad_clip = 1.0
save_iters = [2,5000,7000,8000,9000,9999]  # 保存するイテレーションのリスト
...
for i in pbar:
    ...
    # 特定のイテレーションでモデルを保存
    if i in save_iters:
        save_path = add_ggl_drive_path+f'model_iter_{i}.pt'
